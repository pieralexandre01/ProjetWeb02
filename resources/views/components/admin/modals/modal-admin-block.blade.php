...
<div id="block_admin_{{ $iteration }}" class="modal fade admin_modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex flex-no-wrap align-items-center justify-content-between">
                ...
                <div>
                    <p class="p-0 text-start">You are about to block this user.</p>
                    <p class="p-0 text-start">Click "Confirm" to proceed.</p>
                </div>

                <a href="{{ route('user-block', $id) }}" role="button" class="general_button">CONFIRM</a>
