        ...
        <div class="container d-flex flex-nowrap justify-content-center align-items-center px-lg-3 gap-xl-5">
            ...
            <div class="border_box d-flex flex-column justify-content-between align-items-center align-items-md-stretch gap-1">
                ...
                <div class="d-flex flex-column text-center gap-4 justify-content-between text-md-start gap-md-0">
                    <div class="d-flex flex-column text-center gap-4 justify-content-between flex-nowrap flex-md-row text-md-start gap-md-0">
                        ...
                        <div class="social_media_icons">
                            ...
                            <a href="https://www.facebook.com" class="icon mx-4"><img src="{{ asset('media/icons/facebook.svg') }}" alt="Facebook icon"></a>
                ...
                <div id="google_map" class="pb-1 mt-5 mt-md-0">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2782.746598551334!2d-74.00520964870815!3d45.77626842048395!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4ccf2ca136664c05%3A0x90430ecdc061500!2s297%20Rue%20St%20Georges%2C%20Saint-J%C3%A9r%C3%B4me%2C%20QC%20J7Z%205A2!5e0!3m2!1sen!2sca!4v1679435133586!5m2!1sen!2sca" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="border_box p-0"></iframe>
                </div>
            </div>

            <div class="align-self-center"><img src="{{ asset('/../media/images/contact_us.png') }}" class="d-none d-lg-block ms-lg-3 img-fluid" alt="Digital imaging of planet Earth"></div>
